...
class ExampleElementWithOverrides extends HtmlElement
    with CustomElementProxyMixin, PolymerBase {
  ExampleElementWithOverrides.created() : super.created();
  factory ExampleElementWithOverrides() =>
      new Element.tag('example-element-with-overrides');

  /// A public Array property.
  List get elementArrayProperty => jsElement[r'elementArrayProperty'];
  set elementArrayProperty(List value) {
    jsElement[r'elementArrayProperty'] = (value != null && value is! JsArray)
        ? new JsObject.jsify(value)
        : value;
  }

  num get elementNum => jsElement[r'elementNum'];
  set elementNum(num value) {
    jsElement[r'elementNum'] = value;
  }

  num get elementNumGetterOnly => jsElement[r'elementNumGetterOnly'];

  set elementNumSetterOnly(num value) {
    jsElement[r'elementNumSetterOnly'] = value;
  }

  /// A public property created with the properties descriptor.
  get elementPublicProperty => jsElement[r'elementPublicProperty'];
  set elementPublicProperty(value) {
    jsElement[r'elementPublicProperty'] =
  ...
  set elementReadOnlyProperty(num value) {
    jsElement[r'elementReadOnlyProperty'] = value;
  }

  /// A property whose type will be overridden
  String get elementWrongTypeProperty => jsElement[r'elementWrongTypeProperty'];
  set elementWrongTypeProperty(String value) {
    jsElement[r'elementWrongTypeProperty'] = value;
  }
  ...
  /// This is overridden
  void computedFunction(x, y, z) =>
      jsElement.callMethod('computedFunction', [x, y, z]);

  String elementFunction(String stringParam) =>
      jsElement.callMethod('elementFunction', [stringParam]);

  /// Provide var args
  void elementToBeOverriddenFunction(List varargs) =>
      jsElement.callMethod('elementToBeOverriddenFunction', varargs);

  elementVoidFunction() => jsElement.callMethod('elementVoidFunction', []);
