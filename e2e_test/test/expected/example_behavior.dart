...
abstract class ExampleBehavior implements CustomElementProxyMixin {
  ...
  set behaviorNum(num value) {
    jsElement[r'behaviorNum'] = value;
  }

  num get behaviorNumGetterOnly => jsElement[r'behaviorNumGetterOnly'];

  set behaviorNumSetterOnly(value) {
    jsElement[r'behaviorNumSetterOnly'] =
  ...
  set behaviorPublicProperty(value) {
    jsElement[r'behaviorPublicProperty'] =
        (value is Map || (value is Iterable && value is! JsArray))
            ? new JsObject.jsify(value)
            : value;
  }
  ...
  set behaviorReadOnlyProperty(num value) {
    jsElement[r'behaviorReadOnlyProperty'] = value;
  }

  /// A property whose type will be overridden
  num get behaviorWrongTypeProperty => jsElement[r'behaviorWrongTypeProperty'];
  set behaviorWrongTypeProperty(num value) {
    jsElement[r'behaviorWrongTypeProperty'] = value;
  }
  ...
  behaviorVoidFunction() => jsElement.callMethod('behaviorVoidFunction', []);
}
